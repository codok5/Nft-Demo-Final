...
abstract contract KIP7Mintable is KIP7, AccessControlEnumerable, IKIP7Mintable {
     ...
     */
    function isMinter(address account) public view virtual override returns (bool) {
     ...
     * Emits a {RoleGranted} event
     */
    function addMinter(address account) public virtual override onlyRole(DEFAULT_ADMIN_ROLE) {
...
abstract contract KIP7Pausable is KIP7, Pausable, AccessControlEnumerable, IKIP7Pausable {
     ...
     * @dev Check if `account` has the assigned Pauser role via {AccessControl-hasRole}
     */
    function isPauser(address account) public view virtual override returns (bool) {
     ...
     * - caller must have the {AccessControl-DEFAULT_ADMIN_ROLE}
     */
    function addPauser(address account) public virtual override onlyRole(DEFAULT_ADMIN_ROLE) {
     ...
     * Emits a {RoleRevoked} event
     */
    function renouncePauser() virtual override public {
